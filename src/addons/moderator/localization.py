...
strings = {
    ...
    "ru": {
        ...
        "error_kikc_admin": "😡 Ты чё, пёс? Админа нельзя забанить!",
        "resolved_kick": "<i>Участник исключён из мейна ☣️Black Mesa.</i>",
...
def get_string(key):
    ...
    localization_strings = strings.get("ru", strings.get('ru'))

    if localization_strings is None:
        raise KeyError(f'Neither "ru" nor "en" locales found')
